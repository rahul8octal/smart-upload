...
first clone shopify-remix-template
or
install with shopify CLI : shopify app init

create new App and fill client secret and api in .env
create database and add detail in .env
...
if want to create new migration then edit schema.prisma file.
now run this command

npx prisma migrate dev --name "migration name"

### run script of old databse

node migrate-old-data

### Plan Seeder

node prisma/DatabaseSeeder.js
